    ...
    return [
        {
            ...
            'resolution': row['resolution'], 'estimatedEffort': row['estimated_effort'],
            'actualEffort': row['actual_effort'], 'startDate': row['start_date'],
            'targetDate': row['target_date'], 'dueDate': row['due_date'],
