...
| 2026-08-25 | P3e Circle Profile UI cutover | current change-set | Settings → Profile dùng native Python `/users/me`; họ tên, chức danh và username lưu thật khi rời ô; avatar upload JPEG/PNG/GIF/WebP tối đa 5 MB vào MinIO, còn thiếu ảnh thì hiện chữ cái đầu trên màu xác định từ tên | Email-change và leave-workspace confirmation chưa nằm trong scope Profile slice này | Build web, sau đó người dùng upload/chỉnh Profile và refresh để nghiệm thu |
