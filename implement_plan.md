...
| 2026-08-26 | P8e Project updates native cutover | current change-set | Settings → Project updates không còn placeholder: giữ component Circle có sẵn, feed workspace và Project detail read/create update đi FastAPI/PostgreSQL; author/avatar và Project được trả từ dữ liệu thật, đồng thời static route `/projects/updates` được đăng ký trước dynamic Project detail route | Cần Docker/browser nghiệm thu post update trên Project rồi xem Settings feed và refresh | Rebuild API+web, tạo một Project update, mở Settings → Projects → Updates và refresh |
