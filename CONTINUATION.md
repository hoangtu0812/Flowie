...
Tất cả commit bên dưới đã được push. Commit tính năng gần nhất là `83eede8`; tài liệu này được cập nhật cùng từng lát cắt hoàn chỉnh.
...
11.   Kiểm tra badge Inbox và Settings “Your teams” phản ánh API; Reviews/Agent vẫn unavailable.
12.   Mở một Team settings thật và xác minh team/member/status/cycle cùng các link real; settings chưa có API phải unavailable.
13.   Ghi rõ kết quả runtime vào hai tài liệu này rồi commit/push documentation.
14.   Không mở rộng sang comment attachment, reaction hay sub-issue trong lần xác minh này.
...
2. **Issue detail còn lại** — label editing nếu API hỗ trợ; sub-issues và reactions chỉ làm khi có schema/API/permission đầy đủ. Nếu chưa có thì giữ unavailable.
...
- Issue reactions, comment attachments, sub-issues, PR links.
