...
Tất cả commit bên dưới đã được push. Commit tài liệu gần nhất là `482d163`; commit tính năng gần nhất là `ca19039`.
...
| Issues | Danh sách, tạo/sửa trường cơ bản, filter options, My issues, labels CRUD, cycles, saved views, subscriptions, due dates và archive dùng dữ liệu thật. Issue detail, properties, assignee, status/priority, comments/activity/subscribe, Issue attachment và context-menu actions đã live trong source. Docker runtime verification đang chờ 5G. |
...
5. Ghi rõ kết quả runtime vào hai tài liệu này rồi commit/push documentation.
6. Không mở rộng sang comment attachment, reaction, sub-issue hay relation trong lần xác minh này.
