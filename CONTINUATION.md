...
Tất cả commit bên dưới đã được push. Commit tính năng gần nhất là `1998d53`; tài liệu này được cập nhật cùng từng lát cắt hoàn chỉnh.
...
| Initiatives & documents | Initiative list/detail/create/link/unlink project; team documents đã live. Nút remove trong tab Projects chỉ gọi API DELETE thật rồi reload, lỗi giữ nguyên list và hiện message.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
