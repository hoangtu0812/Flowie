...
Tất cả commit bên dưới đã được push. Commit tính năng gần nhất là `adcc84f`; tài liệu này được cập nhật cùng từng lát cắt hoàn chỉnh.
...
2. **Issue detail còn lại** — sub-issues và reactions chỉ làm khi có schema/API/permission đầy đủ. Nếu chưa có thì giữ unavailable.
