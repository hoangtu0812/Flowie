...
Tất cả commit bên dưới đã được push. Commit tính năng gần nhất là `575e4d9`; tài liệu này được cập nhật cùng từng lát cắt hoàn chỉnh.
...
### Việc cần làm trước khi tiếp tục: authenticated acceptance verification Project list, Attachment, Cycle Document link, Due date, Context menu, Command palette, Sidebar và Team settings
...
10.   Kiểm tra badge Inbox và Settings “Your teams” phản ánh API; Reviews/Agent vẫn unavailable.
11.   Mở một Team settings thật và xác minh team/member/status/cycle cùng các link real; settings chưa có API phải unavailable.
12.   Ghi rõ kết quả runtime vào hai tài liệu này rồi commit/push documentation.
13.   Không mở rộng sang comment attachment, reaction, sub-issue hay relation trong lần xác minh này.
