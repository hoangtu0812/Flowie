...
Tất cả commit bên dưới đã được push. Commit tính năng gần nhất là `7c7db0b`; tài liệu này được cập nhật cùng từng lát cắt hoàn chỉnh.
...
15.   Không mở rộng sang comment attachment trong lần xác minh này.
...
2. **Issue detail còn lại** — comment attachments và PR links chỉ làm khi có schema/API/permission đầy đủ. Nếu chưa có thì giữ unavailable.
